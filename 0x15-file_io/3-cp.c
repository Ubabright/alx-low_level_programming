 ...
 *
 * Return: rreturn 0 on success
 *
 * Description: if argument count is incorrect - exit code 97. exit code 98 -  if file_from does not exist or cannot be read
 *              if file_to cannot be created or written to - exit code 99.
 *            exit code 100 -  if file_to or file_from cannot be closedl
 */
